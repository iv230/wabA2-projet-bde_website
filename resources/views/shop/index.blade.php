    ...
    <div class="articles">
        <div class="container_articles">
            ...
            <div class="articles_items">
                ...
                <a href="" class="article" style="background-image: url('img/tshirt1.jpg'); background-size: cover;">
                    <div class="article_icon"><i class="fas fa-info"></i></div>
                </a>

                <div class="article" style="background-image: url('img/tshirt2.jpg'); background-size: cover;">
                    <div class="article_icon"><i class="fas fa-info"></i></div>
                </div>

                <div class="article" style="background: url('img/tshirt3.jpg'); background-size: cover;">
                    <div class="article_icon"><i class="fas fa-info"></i></div>
                </div>
